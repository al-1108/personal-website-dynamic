    ...
    <div className="bg-slate-900 text-slate-100 min-h-screen">
      ...
      <div id="intro" className="scroll-mt-16 max-w-4xl mx-auto px-6 py-12 sm:py-20">
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 sm:gap-8">
          <div className="flex-1 text-center">
            ...
            <p className="font-display text-2xl sm:text-3xl font-bold mb-2">Hi! Nice to meet you! I'm Alex Lu, and welcome to my Personal Website.</p>
          </div>
      ...
      <div id="experience" className="scroll-mt-16 bg-slate-800 py-12 sm:py-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <Link to="/experience" className="inline-block mt-6 text-sky-400 text-sm font-medium hover:translate-x-1 hover:scale-110 transition-transform origin-left">See all experiences →</Link>
        </div>
      </div>
      ...
      <div id="blogs" className="scroll-mt-16 max-w-4xl mx-auto px-6 py-12 sm:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <Link to="/blogs/first-post" className="bg-slate-800 flex flex-col justify-between border border-slate-700 rounded-xl p-4 hover:border-sky-500 hover:shadow-lg hover:shadow-sky-900/20 transition group">
            <div>
